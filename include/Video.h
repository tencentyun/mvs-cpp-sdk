...
public:
    static const string API_VIDEO_END_POINT;
    ...
    enum VIDEO_ERR_T {
        VIDEO_FILE_NOT_EXISTS = -1,
        VIDEO_NETWORK_ERROR = -2,
        VIDEO_PARAMS_ERROR = -3,
        VIDEO_ILLEGAL_SLICE_SIZE_ERROR = -4
    };
